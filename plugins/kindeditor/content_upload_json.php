...
if (empty($_FILES) === false) {
    ...
    $cthumb_width = intval($config['cthumb_width']);
    $cthumb_height = intval($config['cthumb_height']);

    $cthumb_width = ( 0 >= $cthumb_width ) ? null : $cthumb_width;
    $cthumb_height = ( 0 >= $cthumb_height ) ? null : $cthumb_height;

    if( $cthumb_width && $cthumb_height ) {
        create_thumb($file_path, $file_ext, $cthumb_width, $cthumb_height);
    } else if( empty($cthumb_width) && $cthumb_height) {
        create_thumb($file_path, $file_ext, null, $cthumb_height);
    } else if( $cthumb_width && empty($cthumb_height) ) {
        create_thumb($file_path, $file_ext, $cthumb_width );
    } else {
